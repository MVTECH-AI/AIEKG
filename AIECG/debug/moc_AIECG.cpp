...
static const char qt_meta_stringdata_AIECG[] = {
    "AIECG\0\0newfile()\0print()\0printPreview()\0"
    "setUpPage()\0printer\0printDocument(QPrinter*)\0"
    "cut()\0copy()\0paste()\0about()\0"
    "openChannelWidnow()\0openPlotSignalWindow()\0"
    "openGridSignalWindow()\0openIBISignalWindow()\0"
    "openTextWindow()\0loadText()\0beginSVM()\0"
};
...
void AIECG::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->printPreview(); break;
        case 3: _t->setUpPage(); break;
        case 4: _t->printDocument((*reinterpret_cast< QPrinter*(*)>(_a[1]))); break;
        case 5: _t->cut(); break;
