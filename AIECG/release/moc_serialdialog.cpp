...
static const char qt_meta_stringdata_SerialDialog[] = {
    "SerialDialog\0\0openSerialPort()\0"
};
...
const QMetaObjectExtraData SerialDialog::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject SerialDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_SerialDialog,
      qt_meta_data_SerialDialog, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &SerialDialog::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SerialDialog))
