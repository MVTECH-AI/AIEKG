...
# yet).
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" rev-list --max-count=1 origin/master
  WORKING_DIRECTORY "E:/MITK/ALEGCBIN/MITK"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'E:/MITK/ALEGCBIN/MITK/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'E:/MITK/ALEGCBIN/MITK/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
